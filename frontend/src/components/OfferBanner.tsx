...
import img1 from "/public/img-1-fd8eca61.png";
const OfferBanner = () => {
  return (
    <div className="grid lg:grid-cols-2 px-5 lg:px-20 gap-10 items-center justify-between text-center pt-28">
      <div className="">
        <h2 className="text-[#CA8E46] lg:text-9xl text-8xl font-bold">
          Specials
        </h2>
        <h3 className="text-white text-5xl font-bold font-serif">OF THE DAY</h3>
        <h5 className="text-white text-xl font-bold mt-5">
          Classic Cappuccino
        </h5>
        <p className="mt-2">
